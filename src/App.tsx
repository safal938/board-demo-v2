...
function BoardApp() {
          ...
          if (patientResponse.ok) {
            ...
            try {
              ...
              if (serverResponse.ok) {
                ...
                console.log(
                  `📦 Loaded ${serverItems.length} items from server`
                );
              ...
              console.log(
                "⚠️ Could not load items from server:",
                error.message
              );
            }
            ...
            // Calculate total width of encounters for centering dashboard
  ...
  const addItem = useCallback(
    (type) => {
      ...
      const newItem = {
        ...
        rotation: 0,
        patientData:
          type === "adverse-event-dashboard" || type === "data-zone"
            ? patientData
            : null,
        ehrData:
          type === "ehr"
  ...
  return (
    <AppContainer>
      ...
      <ModernAddButton onClick={() => addItem("text")} title="Add Text Note">
